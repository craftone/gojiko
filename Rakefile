...
task :build do
    ...
    sh "GOOS=windows GOARCH=amd64 go build -o gojikoServer.windows.amd64 goa/*.go"
    sh "GOOS=windows GOARCH=386 go build -o udpResponder.windows.386 udpResponder/*.go"
end
