...
type recvStatForHuman struct {
	// Received bitrate
	Bitrate *string `form:"bitrate,omitempty" json:"bitrate,omitempty" yaml:"bitrate,omitempty" xml:"bitrate,omitempty"`
	// Received bytes
	Bytes *string `form:"bytes,omitempty" json:"bytes,omitempty" yaml:"bytes,omitempty" xml:"bytes,omitempty"`
	// Received invalid bytes
	InvalidBytes *string `form:"invalidBytes,omitempty" json:"invalidBytes,omitempty" yaml:"invalidBytes,omitempty" xml:"invalidBytes,omitempty"`
	// Received invalid packets
	InvalidPackets *string `form:"invalidPackets,omitempty" json:"invalidPackets,omitempty" yaml:"invalidPackets,omitempty" xml:"invalidPackets,omitempty"`
	// Received packets
	Packets *string `form:"packets,omitempty" json:"packets,omitempty" yaml:"packets,omitempty" xml:"packets,omitempty"`
}
...
type RecvStatForHuman struct {
	// Received bitrate
	Bitrate string `form:"bitrate" json:"bitrate" yaml:"bitrate" xml:"bitrate"`
	// Received bytes
	Bytes string `form:"bytes" json:"bytes" yaml:"bytes" xml:"bytes"`
	// Received invalid bytes
	InvalidBytes string `form:"invalidBytes" json:"invalidBytes" yaml:"invalidBytes" xml:"invalidBytes"`
	// Received invalid packets
	InvalidPackets string `form:"invalidPackets" json:"invalidPackets" yaml:"invalidPackets" xml:"invalidPackets"`
	// Received packets
	Packets string `form:"packets" json:"packets" yaml:"packets" xml:"packets"`
}
...
type recvStatForMachie struct {
	// Received bitrate
	Bitrate *float64 `form:"bitrate,omitempty" json:"bitrate,omitempty" yaml:"bitrate,omitempty" xml:"bitrate,omitempty"`
	// Received bytes
	Bytes *int `form:"bytes,omitempty" json:"bytes,omitempty" yaml:"bytes,omitempty" xml:"bytes,omitempty"`
	// Received invalid bytes
	InvalidBytes *int `form:"invalidBytes,omitempty" json:"invalidBytes,omitempty" yaml:"invalidBytes,omitempty" xml:"invalidBytes,omitempty"`
	// Received invalid packets
	InvalidPackets *int `form:"invalidPackets,omitempty" json:"invalidPackets,omitempty" yaml:"invalidPackets,omitempty" xml:"invalidPackets,omitempty"`
	// Received packets
	Packets *int `form:"packets,omitempty" json:"packets,omitempty" yaml:"packets,omitempty" xml:"packets,omitempty"`
}
...
type RecvStatForMachie struct {
	// Received bitrate
	Bitrate float64 `form:"bitrate" json:"bitrate" yaml:"bitrate" xml:"bitrate"`
	// Received bytes
	Bytes int `form:"bytes" json:"bytes" yaml:"bytes" xml:"bytes"`
	// Received invalid bytes
	InvalidBytes int `form:"invalidBytes" json:"invalidBytes" yaml:"invalidBytes" xml:"invalidBytes"`
	// Received invalid packets
	InvalidPackets int `form:"invalidPackets" json:"invalidPackets" yaml:"invalidPackets" xml:"invalidPackets"`
	// Received packets
	Packets int `form:"packets" json:"packets" yaml:"packets" xml:"packets"`
}
...
type sendRecvStatistics struct {
	// seconds
	Duration *float64   `form:"duration,omitempty" json:"duration,omitempty" yaml:"duration,omitempty" xml:"duration,omitempty"`
	...
	RecvStats *recvStatForMachie `form:"recvStats,omitempty" json:"recvStats,omitempty" yaml:"recvStats,omitempty" xml:"recvStats,omitempty"`
	// receive statistics for humans
	RecvStatsHumanize *recvStatForHuman `form:"recvStatsHumanize,omitempty" json:"recvStatsHumanize,omitempty" yaml:"recvStatsHumanize,omitempty" xml:"recvStatsHumanize,omitempty"`
	// send statistics for machines
	SendStats *sendStatForMachie `form:"sendStats,omitempty" json:"sendStats,omitempty" yaml:"sendStats,omitempty" xml:"sendStats,omitempty"`
	// send statistics for humans
	SendStatsHumanize *sendStatForHuman `form:"sendStatsHumanize,omitempty" json:"sendStatsHumanize,omitempty" yaml:"sendStatsHumanize,omitempty" xml:"sendStatsHumanize,omitempty"`
...
type SendRecvStatistics struct {
	// seconds
	Duration float64    `form:"duration" json:"duration" yaml:"duration" xml:"duration"`
	EndTime  *time.Time `form:"endTime,omitempty" json:"endTime,omitempty" yaml:"endTime,omitempty" xml:"endTime,omitempty"`
	// receive statistics for machines
	RecvStats *RecvStatForMachie `form:"recvStats" json:"recvStats" yaml:"recvStats" xml:"recvStats"`
	// receive statistics for humans
	RecvStatsHumanize *RecvStatForHuman `form:"recvStatsHumanize" json:"recvStatsHumanize" yaml:"recvStatsHumanize" xml:"recvStatsHumanize"`
	// send statistics for machines
	SendStats *SendStatForMachie `form:"sendStats" json:"sendStats" yaml:"sendStats" xml:"sendStats"`
	// send statistics for humans
	SendStatsHumanize *SendStatForHuman `form:"sendStatsHumanize" json:"sendStatsHumanize" yaml:"sendStatsHumanize" xml:"sendStatsHumanize"`
...
type sendStatForHuman struct {
	...
	Packets *string `form:"packets,omitempty" json:"packets,omitempty" yaml:"packets,omitempty" xml:"packets,omitempty"`
	// Skipped bytes
	SkippedBytes *string `form:"skippedBytes,omitempty" json:"skippedBytes,omitempty" yaml:"skippedBytes,omitempty" xml:"skippedBytes,omitempty"`
	// Skipped packets
	SkippedPackets *string `form:"skippedPackets,omitempty" json:"skippedPackets,omitempty" yaml:"skippedPackets,omitempty" xml:"skippedPackets,omitempty"`
}
...
type SendStatForHuman struct {
	...
	Packets string `form:"packets" json:"packets" yaml:"packets" xml:"packets"`
	// Skipped bytes
	SkippedBytes string `form:"skippedBytes" json:"skippedBytes" yaml:"skippedBytes" xml:"skippedBytes"`
	// Skipped packets
	SkippedPackets string `form:"skippedPackets" json:"skippedPackets" yaml:"skippedPackets" xml:"skippedPackets"`
}
...
type sendStatForMachie struct {
	...
	Packets *int `form:"packets,omitempty" json:"packets,omitempty" yaml:"packets,omitempty" xml:"packets,omitempty"`
	// Skipped bytes
	SkippedBytes *int `form:"skippedBytes,omitempty" json:"skippedBytes,omitempty" yaml:"skippedBytes,omitempty" xml:"skippedBytes,omitempty"`
	// Skipped packets
	SkippedPackets *int `form:"skippedPackets,omitempty" json:"skippedPackets,omitempty" yaml:"skippedPackets,omitempty" xml:"skippedPackets,omitempty"`
}
...
type SendStatForMachie struct {
	...
	Packets int `form:"packets" json:"packets" yaml:"packets" xml:"packets"`
	// Skipped bytes
	SkippedBytes int `form:"skippedBytes" json:"skippedBytes" yaml:"skippedBytes" xml:"skippedBytes"`
	// Skipped packets
	SkippedPackets int `form:"skippedPackets" json:"skippedPackets" yaml:"skippedPackets" xml:"skippedPackets"`
}
...
type udpEchoFlowPayload struct {
	...
	DestAddr *string `form:"destAddr,omitempty" json:"destAddr,omitempty" yaml:"destAddr,omitempty" xml:"destAddr,omitempty"`
	// ECHO destination UDP port
	DestPort *int `form:"destPort,omitempty" json:"destPort,omitempty" yaml:"destPort,omitempty" xml:"destPort,omitempty"`
	// Number of send packets
	NumOfSend *int `form:"numOfSend,omitempty" json:"numOfSend,omitempty" yaml:"numOfSend,omitempty" xml:"numOfSend,omitempty"`
	// Receive packet size (including IP header)
	RecvPacketSize *int `form:"recvPacketSize,omitempty" json:"recvPacketSize,omitempty" yaml:"recvPacketSize,omitempty" xml:"recvPacketSize,omitempty"`
	// Send packet size (including IP header)
	SendPacketSize *int `form:"sendPacketSize,omitempty" json:"sendPacketSize,omitempty" yaml:"sendPacketSize,omitempty" xml:"sendPacketSize,omitempty"`
	// ECHO source UDP port
	SourcePort *int `form:"sourcePort,omitempty" json:"sourcePort,omitempty" yaml:"sourcePort,omitempty" xml:"sourcePort,omitempty"`
	// Target bitrate(bps) in SGi not S5/S8
	TargetBps *int `form:"targetBps,omitempty" json:"targetBps,omitempty" yaml:"targetBps,omitempty" xml:"targetBps,omitempty"`
	// Type of service
	Tos *int `form:"tos,omitempty" json:"tos,omitempty" yaml:"tos,omitempty" xml:"tos,omitempty"`
	// Time To Live
	TTL *int `form:"ttl,omitempty" json:"ttl,omitempty" yaml:"ttl,omitempty" xml:"ttl,omitempty"`
}
...
type UDPEchoFlowPayload struct {
	// ECHO destination IPv4 address
	DestAddr string `form:"destAddr" json:"destAddr" yaml:"destAddr" xml:"destAddr"`
	// ECHO destination UDP port
	DestPort int `form:"destPort" json:"destPort" yaml:"destPort" xml:"destPort"`
	// Number of send packets
	NumOfSend int `form:"numOfSend" json:"numOfSend" yaml:"numOfSend" xml:"numOfSend"`
	// Receive packet size (including IP header)
	RecvPacketSize int `form:"recvPacketSize" json:"recvPacketSize" yaml:"recvPacketSize" xml:"recvPacketSize"`
	// Send packet size (including IP header)
	SendPacketSize int `form:"sendPacketSize" json:"sendPacketSize" yaml:"sendPacketSize" xml:"sendPacketSize"`
	// ECHO source UDP port
	SourcePort int `form:"sourcePort" json:"sourcePort" yaml:"sourcePort" xml:"sourcePort"`
	// Target bitrate(bps) in SGi not S5/S8
	TargetBps int `form:"targetBps" json:"targetBps" yaml:"targetBps" xml:"targetBps"`
	// Type of service
	Tos int `form:"tos" json:"tos" yaml:"tos" xml:"tos"`
	// Time To Live
	TTL int `form:"ttl" json:"ttl" yaml:"ttl" xml:"ttl"`
}
...
type ecgi struct {
	...
	Eci *int `form:"eci,omitempty" json:"eci,omitempty" yaml:"eci,omitempty" xml:"eci,omitempty"`
	// Mobile Country Code
...
type Ecgi struct {
	// E-UTRAN Cell Identifier
	Eci int `form:"eci" json:"eci" yaml:"eci" xml:"eci"`
	// Mobile Country Code
...
// fteid user type.
type fteid struct {
	Ipv4 *string `form:"ipv4,omitempty" json:"ipv4,omitempty" yaml:"ipv4,omitempty" xml:"ipv4,omitempty"`
	Teid *string `form:"teid,omitempty" json:"teid,omitempty" yaml:"teid,omitempty" xml:"teid,omitempty"`
}
...
// Fteid user type.
type Fteid struct {
	Ipv4 string `form:"ipv4" json:"ipv4" yaml:"ipv4" xml:"ipv4"`
	Teid string `form:"teid" json:"teid" yaml:"teid" xml:"teid"`
}
...
type gtpSessionFTEIDs struct {
	PgwCtrlFTEID *fteid `form:"pgwCtrlFTEID,omitempty" json:"pgwCtrlFTEID,omitempty" yaml:"pgwCtrlFTEID,omitempty" xml:"pgwCtrlFTEID,omitempty"`
	PgwDataFTEID *fteid `form:"pgwDataFTEID,omitempty" json:"pgwDataFTEID,omitempty" yaml:"pgwDataFTEID,omitempty" xml:"pgwDataFTEID,omitempty"`
	SgwCtrlFTEID *fteid `form:"sgwCtrlFTEID,omitempty" json:"sgwCtrlFTEID,omitempty" yaml:"sgwCtrlFTEID,omitempty" xml:"sgwCtrlFTEID,omitempty"`
	SgwDataFTEID *fteid `form:"sgwDataFTEID,omitempty" json:"sgwDataFTEID,omitempty" yaml:"sgwDataFTEID,omitempty" xml:"sgwDataFTEID,omitempty"`
}
...
// ratType user type.
type ratType struct {
	RatType *string `form:"ratType,omitempty" json:"ratType,omitempty" yaml:"ratType,omitempty" xml:"ratType,omitempty"`
...
// RatType user type.
type RatType struct {
	RatType string `form:"ratType" json:"ratType" yaml:"ratType" xml:"ratType"`
	// Default is 6 : E-UTRAN (WB-E-UTRAN)
...
type tai struct {
	...
	Mnc *string `form:"mnc,omitempty" json:"mnc,omitempty" yaml:"mnc,omitempty" xml:"mnc,omitempty"`
	// Tracking Area Code
	Tac *int `form:"tac,omitempty" json:"tac,omitempty" yaml:"tac,omitempty" xml:"tac,omitempty"`
}
...
type Tai struct {
	...
	Mnc string `form:"mnc" json:"mnc" yaml:"mnc" xml:"mnc"`
	// Tracking Area Code
	Tac int `form:"tac" json:"tac" yaml:"tac" xml:"tac"`
}
