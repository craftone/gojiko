...
type Gtpsession struct {
	...
	Fteid *GtpSessionFTEIDs `form:"fteid,omitempty" json:"fteid,omitempty" yaml:"fteid,omitempty" xml:"fteid,omitempty"`
	...
	Paa     string   `form:"paa" json:"paa" yaml:"paa" xml:"paa"`
	RatType *RatType `form:"ratType" json:"ratType" yaml:"ratType" xml:"ratType"`
	// Session ID in this SGW
	Sid int  `form:"sid" json:"sid" yaml:"sid" xml:"sid"`
...
type Gtpv2cCause struct {
	...
	Value int `form:"value" json:"value" yaml:"value" xml:"value"`
}
...
type Gtpv2cCsres struct {
	Cause       *Gtpv2cCause `form:"cause" json:"cause" yaml:"cause" xml:"cause"`
	SessionInfo *Gtpsession  `form:"sessionInfo" json:"sessionInfo" yaml:"sessionInfo" xml:"sessionInfo"`
}
...
type Udpechoflow struct {
	Param *UDPEchoFlowPayload `form:"param,omitempty" json:"param,omitempty" yaml:"param,omitempty" xml:"param,omitempty"`
}
...
type UdpechoflowWithStats struct {
	Param *UDPEchoFlowPayload `form:"param,omitempty" json:"param,omitempty" yaml:"param,omitempty" xml:"param,omitempty"`
	Stats *SendRecvStatistics `form:"stats,omitempty" json:"stats,omitempty" yaml:"stats,omitempty" xml:"stats,omitempty"`
}
