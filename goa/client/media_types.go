...
// DecodeGtpv2cCsres decodes the Gtpv2cCsres instance encoded in resp body.
func (c *Client) DecodeGtpv2cCsres(resp *http.Response) (*Gtpv2cCsres, error) {
	var decoded Gtpv2cCsres
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
